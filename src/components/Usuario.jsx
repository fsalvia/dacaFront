  ...
  return (
    <tr className="border-b border-gray-800 hover:bg-gray-200">
      ...
      <td className="p-1 text-center">
        ...
        <button className="bg-yellow-600 rounded-md p-0.5 ml-2 text-gray-600 hover:bg-yellow-400" onClick={() => navigate(`/usuarios/editar/${id}`)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
            fill="none"
