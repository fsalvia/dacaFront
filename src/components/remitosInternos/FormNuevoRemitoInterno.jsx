...
const FormNuevoRemitoInterno = ({ remitoInterno }) => {
  ...
  useEffect(() => {
    ...
    if (remitoInterno?.id > 0) {
      const arrItem = remitoInterno.itemsList;
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      let response;
      if (remitoInterno != null) {
        const url = `${BACKEND}/api/internalNote/${remitoInterno.id}`;
    ...
    <div className="pl-6">
      <Formik
        initialValues={{
          ...
          itemsList: remitoInterno?.itemsList ?? "",
          project: remitoInterno?.project ?? "",
        }}
        ...
        validationSchema={newRemitoInternoSchema}
      >
        {({ errors, touched }) => {
          return (
            <Form>
              <div className="p-6">
                <div className="bg-gray-700 p-4 rounded-md">
                  <div className="grid grid-cols-2">
                    <div className="pr-3">
                      ...
                      <Field
                        ...
                        placeholder="Fecha de Creación del Remito"
                        name="dateOfIssue"
                      />
                    ...
                    <div className="pl-3">
                      ...
                      <Field
                        ...
                        type="date"
                        className="mt-2 text-sm block w-full p-1 bg-gray-200 rounded-md"
                        placeholder="Fecha en que desea ser avisado"
                        name="reminderDate"
                      />
                    ...
                    <div className="pl-3 pt-1.5">
                      <label className="text-gray-200" htmlFor="recipient">
                        Destinatario:
                      </label>
                      <Field
                        id="recipient"
                        type="text"
                        className="mt-2 text-sm block w-full p-1 bg-gray-200 rounded-md"
                        placeholder="Persona a entregar materiales/herramientas"
                        name="recipient"
                      />
                    ...
                    <div className="pt-1.5 col-span-2">
                      <label className="text-gray-200" htmlFor="observation">
                        Observaciones:
                      </label>
                      <Field
                        id="observation"
                        ...
                        placeholder="Notas/aclaraciones sobre el remito"
                        name="observation"
                      />
                    </div>
                  </div>
                  ...
                  <input
                    type="submit"
                    value={
                      remitoInterno?.id ? "Editar Remito" : "Agregar Remito"
                    }
...
export default FormNuevoRemitoInterno;
