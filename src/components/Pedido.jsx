...
const Pedido = ({ pedido, handleEliminar, handleAprobar, handlePrecarga, handlePDF, urlActual }) => {
  ...
  function ApproveButton(orderState) {
    ...
    } else if (urlActual===undefined) {
      return (
        <button
          className="bg-green-600 rounded-md p-0.5 text-gray-600 hover:bg-green-400"
          onClick={() => handlePrecarga(pedido)}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
  ...
  return (
    <tr className="border-b border-gray-800 hover:bg-gray-200">
      ...
      <td className="pt-3 p-2 text-center">
        ...
        {PDFButton(urlActual === "/pedidos/listado")}
      </td>
    </tr>
  );
};
